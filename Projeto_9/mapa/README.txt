Interface Gráfica - Atividade da semana de break BUG2
...
4- Antes de iniciar o plot de poses, executar os seguintes comandos na interface:
	...
	4.2- 'i' para visualizar o esboço do mapa
...
8- Renomear as imagens salvas com informação sobre o ponto de partida, exemplo:
	inicioEmS.png
	inicioEmG.png
